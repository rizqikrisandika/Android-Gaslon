...
public class Orderloc extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                destination = txtKirim.getText().toString();
                destination = destination.replace(" ","+");
                mapFragment.getMapAsync(Orderloc.this);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            mService.getDataFormGoogleApi(requestUrl)
                    .enqueue(new Callback<String>() {
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(Orderloc.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }catch (Exception e){
            e.printStackTrace();
